    ...
    <section>
      <div className="md:px-[12.5vw] md:py-[11.11vh] grid grid-cols-6 md:gap-x-[1.25vw]">
        ...
        >
          ...
          <button className="bg-white text-[#1B1743] md:py-[1.48vh] md:px-[1.25vw] rounded-md md:text-[1.48vh] md:leading-[2.22vh] font-semibold">
            Отправить
          </button>
        </form>
        <div className={`col-span-2 ${montserrat.className}`}>
          ...
          <div className="flex md:gap-x-[12px]">
            <Image src={IconPin} alt={`IconPin`} width={24} className="md:h-[2.22vh] md:w-[1.25vw] object-contain" />
            <div className=''>
              <p className="md:pb-[1.11vh] md:text-[1.66vh] md:leading-[2.22vh] font-bold">г. Красноярск</p>
              <p className="md:text-[1.48vh] md:leading-[2.22vh] font-medium">Работаю удаленно по всей России</p>
            </div>
          </div>
        </div>
